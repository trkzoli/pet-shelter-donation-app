  ...
  return (
    <View style={styles.bottomNav}>
      ...
      <TouchableOpacity style={styles.navButton} onPress={() => router.push('/shelter-home')}>
        <View style={[styles.navIconWrapper, pathname === '/shelter-home' && styles.activeNavIconWrapper]}>
      ...
      <TouchableOpacity style={styles.navButton} onPress={() => router.push('/shelter-pets-add')}>
        <View style={[styles.navIconWrapper, pathname === '/shelter-pets-add' && styles.activeNavIconWrapper]}>
      ...
      <TouchableOpacity style={styles.navButton} onPress={() => router.push('/shelter-profile')}>
        <View style={[styles.navIconWrapper, pathname === '/shelter-profile' && styles.activeNavIconWrapper]}>
          <Image source={require('../../assets/images/sprofile.png')} style={styles.navIcon} />
        </View>
      </TouchableOpacity>
    </View>
  );
