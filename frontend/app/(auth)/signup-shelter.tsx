...
const ShelterSignupScreen: React.FC = () => {
  ...
  const getPhoneBorderColor = () => {
    if (!fieldsTouched.phone) return '#797979';
    if (!formData.phone) return '#797979';
    return isValidPhone(formData.phone) ? '#51CF66' : '#FF6B6B';
  };
  ...
  const handlePhoneBlur = useCallback(() => {
    setFieldsTouched(prev => ({ ...prev, phone: true }));
  }, []);
  ...
  const handleSignUp = useCallback(async () => {
    ...
    if (!formData.email.trim()) {
      showAlert({
        ...
        message: 'Please enter your shelter email address.',
        type: 'warning',
        buttonText: 'OK'
      });
      return;
    ...
    if (!formData.phone.trim()) {
      showAlert({
        ...
        message: 'Please enter your shelter contact number.',
        type: 'warning',
        buttonText: 'OK'
      });
      return;
    ...
    try {
      ...
      const response = await axios.post(`${API_BASE_URL}/auth/register/shelter`, {
        ...
        >
          ...
          <View style={[styles.inputContainer, { width: availableWidth * 0.9 }]}>
            <TextInput
              ...
              accessibilityHint="Enter your shelter's email address"
            />
          ...
          <View style={[styles.inputContainer, { width: availableWidth * 0.9 }]}>
            <TextInput
              ...
              accessibilityHint="Enter your shelter's contact phone number"
            />
            {fieldsTouched.phone && formData.phone && !isValidPhone(formData.phone) && (
          ...
          <View style={[styles.inputContainer, { width: availableWidth * 0.9 }]}>
            <View style={[styles.passwordContainer, { width: '100%' }]}>
              <TextInput
                ...
                accessibilityHint="Enter a secure password for your shelter account"
              />
              <TouchableOpacity
          ...
          <TouchableOpacity
            ...
            disabled={isLoading}
            accessibilityRole="button"
            accessibilityLabel="Create your shelter account"
